...
<head>
  ...
  <title>Sispa - Sistem Pakar Diagnosa Penyakit Diare</title>
...
<body onload="tampilkanwaktu();setInterval('tampilkanwaktu()', 1000);">
  ...
  <h1 class="site-heading text-center d-none d-lg-block">
    <span class="site-heading-upper text-primary mb-3">Diagnosa Penyakit Diare</span>
        ...
        <div class="row">
          <div class="col-xl-9 col-lg-10 mx-auto">
            <div class="bg-faded rounded p-5">
              ...
              <p style="text-align: justify;">Sistem Pakar diagnosa penyakit Diare merupakan sebuah sistem yang mampu melakukan diagnosa penyakit Diare berdasarkan gejala yang dapat dirasakan. untuk melakukan diagnosa penyakit, terdapat beberapa tatacara dan aturan yang harus dilakukan, adalah sebagai berikut:</p>
              ...
              <p class="mb-0">Diagnosa penyakit pada sistem dilakukan dengan perhitungan yang menggunakan metode <i>Dempster-Shafer</i> dengan nilai kepercayaan bersumber dari pakar/dokter Pencernaan (Gastroenterologi), guna melakukan upaya penanganan dini terhadap penyakit tersebut. tetapi akan lebih baik jika melakukan konsultasi ulang bersama dokter ahli pencernaan, agar masalah yang anda hadapi dapat ditangani lebih baik.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer class="footer text-faded text-center py-5">
    <div class="container">
      <p style="color: white;">Jumlah riwayat diagnosa saat ini : <?php echo $cl->jum; ?> | Copyright &copy; Sispa 2020</p>
    </div>
  </footer>
